...
@section('contenido')
    <div class="container mx-auto md:flex gap-4">
        <div class="md:w-1/2 ">
            <img src="{{asset('uploads').'/'.$post->imagen}}" alt="{{$post->descripcion}}">
                    ...
                    @if ($post->user_id === auth()->user()->id)
                        <form action="{{route('post.destroy',[$post->id])}}" method="POST">
                            ...
                            <input type="submit"
                                    ...
                                    class="bg-red-500 hover:bg-red-800 p-2 rounded
        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                    ...
                    @endif
                    <form action="{{route('comentarios.store',['user'=> $user,'posts'=>$post])}}" method="POST">
                        @csrf
                        <div class="mb-5">
